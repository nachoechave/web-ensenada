  ...
  accesos: [
    {
      ...
      descripcion: 'Gestión de avisos y documentación tributaria.',
      url: 'https://boletadigital.ensenada.gov.ar/',
      icono: 'document',
    },
    {
      titulo: 'Tasas municipales',
      descripcion: 'Consulta y pago online de tasas.',
      url: 'https://www.ensenada.gov.ar/',
      icono: 'coins',
    },
    {
      titulo: 'Turnos',
      descripcion: 'Solicitá turnos para distintos servicios.',
      url: 'https://www.ensenada.gov.ar/',
      icono: 'calendar',
    },
    {
      titulo: 'Hacienda',
      descripcion: 'Publicaciones e información fiscal.',
      url: '/hacienda',
      icono: 'building',
    },
  ],
  tramites: {
    kicker: 'Trámites y servicios',
    titulo: 'Realizá tus trámites de forma simple',
    bajada:
      'Accedé a los principales trámites y servicios municipales de manera online o presencial.',
    items: [
