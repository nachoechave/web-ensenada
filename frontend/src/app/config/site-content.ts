...
export const defaultPortalContent: PortalContent = {
  ...
  accesosTitulo: 'Accesos directos',
  accesos: [
    {
      titulo: 'Recibos de haberes',
      descripcion: 'Consultá y descargá tus recibos de haberes municipales.',
      url: 'https://haberes.ensenada.gov.ar/',
      icono: 'receipt',
    },
    {
    ...
    {
      titulo: 'Factura web',
      descripcion: 'Accedé al sistema municipal de facturación y pagos.',
      url: 'https://pagos.ensenada.gov.ar/nuevo_index.php',
      icono: 'invoice',
    },
    {
      titulo: 'Avisos por mail',
      descripcion: 'Gestioná avisos y comunicaciones electrónicas municipales.',
      url: 'https://avisos.ensenada.gov.ar/',
      icono: 'mail',
    },
  ],
  tramites: {
